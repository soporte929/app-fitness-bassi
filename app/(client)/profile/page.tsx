...
export default async function ProfilePage() {
  ...
  if (profile.role === "client") {
    ...
    if (clientRecord) {
      ...
      joinedDate = new Date(
        clientRecord.joined_date + "T00:00:00",
  ...
  return (
    <PageTransition>
      <div className="px-4 pt-6 pb-24">
        <h1 className="text-2xl font-bold text-[var(--text-primary)] tracking-tight mb-6">
          Perfil
        </h1>
          ...
          <div className="grid grid-cols-3 gap-3 mb-5">
            <Card>
              <CardContent className="py-3 px-3 text-center">
                ...
                <p className="text-lg font-bold text-[var(--text-primary)] font-[family-name:var(--font-geist-mono)]">
                  {streak}
                </p>
            ...
            <Card>
              <CardContent className="py-3 px-3 text-center">
                ...
                <p className="text-lg font-bold text-[var(--success)] font-[family-name:var(--font-geist-mono)]">
                  {adherence}%
                </p>
                <p className="text-[10px] text-[var(--text-muted)] font-medium">
                  adherencia
