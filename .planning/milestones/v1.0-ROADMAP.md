...
Plans:
- [x] 01-01-PLAN.md — Create startWorkoutSession action + /workout/[sessionId] page (core session, set logging, finish flow)
- [x] 01-02-PLAN.md — Wire navigation: today/ redirect + active session banner update
