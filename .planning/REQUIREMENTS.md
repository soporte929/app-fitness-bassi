...
- [x] **INFRA-02**: La tabla `foods` contiene seed inicial con 13 alimentos base (pollo, huevos, atún, ternera, salmón, arroz, pasta, patata, avena, pan, aceite oliva, aguacate, frutos secos)
...
- [x] **PROG-01**: El cliente puede registrar su peso actual desde la página `/progress`
- [x] **PROG-02**: El peso objetivo del cliente aparece como línea de referencia en la gráfica de peso
- [x] **PROG-03**: El cliente puede registrar medidas corporales (cintura, cadera, pecho, brazo, muslo) desde `/progress`

### AI Nutrition — Claude API (AI)

- [x] **AI-01**: El cliente puede abrir un modal y escribir una descripción libre de un alimento
- [x] **AI-02**: La app llama a Claude API server-side y devuelve los macros estimados del alimento descrito
- [x] **AI-03**: El cliente ve los macros estimados en un paso de confirmación antes de guardarlos en su diario
- [x] **AI-04**: Si Claude no puede interpretar el alimento, el cliente ve un fallback para entrada manual de macros

### Trainer — Completar (TRN)

- [x] **TRN-01**: El entrenador puede navegar y gestionar la librería de ejercicios desde `/exercises`
- [x] **TRN-02**: El botón "Ver historial" en el detalle de un cliente navega al historial de sesiones de ese cliente
- [x] **TRN-03**: Los links muertos del sidebar del trainer (`/reports`, `/settings`) están eliminados o redirigidos
...
| CALC-02 | Phase 23 | Pending |
| CALC-03 | Phase 23 | Pending |
| CALC-04 | Phase 23 | Pending |
| CALC-05 | Phase 23 | Pending |
| TPLAN-01 | Phase 9 | Pending |
| TPLAN-02 | Phase 9 | Pending |
| TPLAN-03 | Phase 21 | Pending |
...
| TRN-03 | Phase 14 | Complete |
| V41-01 | Phase 21 | Pending |
...
- Unmapped: 0
- Gap closure phases assigned: CALC-01-05 → Phase 23; TPLAN-03/06/07/08 → Phase 21; CNUTR-01-06 → Phase 22; AI-03/V41-05/V41-06 → Phase 20; V41-01-03 → Phase 21

---
*Requirements defined: 2026-03-09*
*Last updated: 2026-03-10 — Gap closure phases 20-23 added after v4.2 audit; V41 requirements added to traceability; PROG-01-03 stale checkboxes corrected; CALC-01-05 reassigned to Phase 23 (gap closure)*
